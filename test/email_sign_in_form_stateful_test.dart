...
void main() {
  ...
  void stubSignInWithEmailAndPasswordSucceeds(){
      when(mockAuth.signInWithEmailAndPassword(any, any)).thenAnswer((_) => Future<User>.value(User(uid: '123', displayName: "agustin", photoUrl: "",)));
  }

  void stubSignInWithEmailAndPasswordThrows(){
      when(mockAuth.signInWithEmailAndPassword(any, any)).thenThrow(PlatformException(code: 'ERROR_WRONG_PASSWORD'));
  }
  ...
  group('Sign-In', (){
    ...
    testWidgets(
      ...
      'AND user taps on the signin button '
